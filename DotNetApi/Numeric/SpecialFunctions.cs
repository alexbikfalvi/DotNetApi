...
namespace DotNetApi.Numeric
{
	public static class SpecialFunctions
	{
		...
		/// Copyright Sergey Bochkanov (ALGLIB project)
		/// </summary>
		...
		public static double Erf(double x)
		{
			...
			result = s * (1 - SpecialFunctions.Erfc(x));
			return result;
		}
		...
		public static double Erfc(double x)
		{
			...
			{
				result = 2 - SpecialFunctions.Erfc(-x);
				return result;
			}
			if ((double)(x) < (double)(0.5))
			{
				result = 1.0 - SpecialFunctions.Erf(x);
				return result;
			}
			if ((double)(x) >= (double)(10))
			{
		...
		/// Copyright Sergey Bochkanov (ALGLIB project)
		/// </summary>
		/// <param name="e">The argument value.</param>
		/// <returns>The function value.</returns>
		public static double InvErf(double e)
		{
			return SpecialFunctions.InvNormalDistribution(0.5 * (e + 1)) / Math.Sqrt(2);
		}
		...
		/// Copyright Sergey Bochkanov (ALGLIB project)
		/// </summary>
		/// <param name="y0">The argument value.</param>
		/// <returns>The function value.</returns>
