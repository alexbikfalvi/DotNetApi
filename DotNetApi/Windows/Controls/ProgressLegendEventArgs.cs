...
{
	/// <summary>
	/// A delegate representing a progress legend event handler.
	/// </summary>
	/// <param name="sender">The sender object.</param>
	/// <param name="e">The event arguments.</param>
	public delegate void ProgressLegendEventHandler(object sender, ProgressLegendEventArgs e);

	/// <summary>
	/// A class representing a progress legend event arguments.
	/// </summary>
	public class ProgressLegendEventArgs : EventArgs
	{
		/// <summary>
