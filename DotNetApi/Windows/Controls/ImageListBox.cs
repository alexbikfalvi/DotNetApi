	...
	public class ImageListBox : ListBox
	{
		...
		void OnDrawItem(object sender, DrawItemEventArgs e)
		{
			...
			if (null != item.Text)
			{
				TextRenderer.DrawText(
					e.Graphics,
					item.Text,
					this.Font,//new System.Drawing.Font(SystemFonts.MenuFont.FontFamily, this.Font., FontStyle.Bold),
					rectText,
					e.ForeColor,
		...
		void OnDoubleClick(object sender, EventArgs e)
		{
			if ((this.SelectedItem != null) && (this.ItemActivate != null))
				this.ItemActivate(sender, this.SelectedItem as ImageListBoxItem);
		}
	}
}
