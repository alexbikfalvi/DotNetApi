...
{
	/// <summary>
	/// A base class for thread-safe container controls.
	/// </summary>
	public class ThreadSafePanel : ContainerControl
	{
		private readonly ManualResetEvent eventHandleCreated = new ManualResetEvent(false);
		private readonly Action<Action> action;

		/// <summary>
		/// Creates a new thread-safe container control instance.
		/// </summary>
		public ThreadSafePanel()
		{
